...
<head>
    ...
    <link href="{{ asset('assets/auth/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css') }}"
        rel="stylesheet" type="text/css" />

    <!-- DataTables -->
    <link href="{{ asset('assets/auth/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}" rel="stylesheet"
        type="text/css" />

    <!-- Responsive datatable examples -->
    <link href="{{ asset('assets/auth/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}"
        rel="stylesheet" type="text/css" />

    <!-- Bootstrap Css -->
    <link href="{{ asset('assets/auth/css/bootstrap.min.css') }}" id="bootstrap-style" rel="stylesheet"
        type="text/css" />
    <!-- Icons Css -->
...
<body data-topbar="dark">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="logo-sm" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('assets/auth/images/logo-dark.png') }}" alt="logo-dark"
                                    height="20">
                            </span>
                        </a>
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="logo-sm-light"
                                    height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="logo-light"
                                    height="20">
                            </span>
                        </a>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div>
                                                <img src="{{ asset('assets/auth/images/logo-sm.png') }}"
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-none d-sm-inline-block">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            ...
                            <img class="" src="{{ asset('assets/auth/images/logo-sm.png') }}"
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="user-image"
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <div class="px-lg-2">
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="Github">
                                            <span>GitHub</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="bitbucket">
                                            <span>Bitbucket</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="dribbble">
                                            <span>Dribbble</span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="dropbox">
                                            <span>Dropbox</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="slack">
                                            <span>Slack</span>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="dropdown d-inline-block user-dropdown">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset('assets/auth/images/logo-sm.png') }}" alt="Header Avatar">
        ...
        <div class="vertical-menu">
            ...
            <div data-simplebar class="h-100">
                ...
                <div class="user-profile text-center mt-3">
                    <div class="">
                        <img src="{{ asset('assets/auth/images/logo-sm.png') }}" alt=""
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                <div class="mb-2">
                    <img src="{{ asset('assets/auth/images/logo-sm.png') }}" class="img-fluid img-thumbnail"
                        alt="layout-1">
                </div>
    ...
    <!-- JAVASCRIPT -->
    <script src="{{ asset('assets/auth/images/logo-sm.png') }}"></script>
    <script src="{{ asset('assets/auth/images/logo-sm.png') }}"></script>
    <script src="{{ asset('assets/auth/images/logo-sm.png') }}"></script>
    <script src="{{ asset('assets/auth/images/logo-sm.png') }}"></script>
    <script src="{{ asset('assets/auth/images/logo-sm.png') }}"></script>
    ...
    <!-- apexcharts -->
    <script src="{{ asset('assets/images/logo-sm.png') }}"></script>
