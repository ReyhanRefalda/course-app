...
<body class="bg-belibang-black font-poppins text-white">
        ...
        <div class="container max-w-[1130px] mx-auto flex items-center justify-between h-[74px]">
            <div class="flex items-center gap-[26px]">
                <a href="{{ route('front.index') }}" class="flex w-[154px] shrink-0 items-center">
                    <img src="assets/images/logos/courseapp.png " alt="logo">
                </a>
    ...
    <section id="NewProduct" class="container max-w-[1130px] mx-auto mb-[102px] flex flex-col gap-8">
        ...
        <div class="grid grid-cols-4 gap-[22px]">
            ...
            <div class="product-card flex flex-col rounded-[18px] bg-[#181818] overflow-hidden">
                <a href="" class="thumbnail w-full h-[180px] flex shrink-0 overflow-hidden relative">
                    <img src="assets/images/thumbnails/img2.png" class="w-full h-full object-cover" alt="thumbnail">
                    <p class="backdrop-blur bg-black/30 rounded-[4px] p-[4px_8px] absolute top-3 right-[14px] z-10">Rp
                        700,000</p>
                </a>
                <div class="p-[10px_14px_12px] h-full flex flex-col justify-between gap-[14px]">
            ...
            <div class="product-card flex flex-col rounded-[18px] bg-[#181818] overflow-hidden">
                <a href="" class="thumbnail w-full h-[180px] flex shrink-0 overflow-hidden relative">
                    <img src="assets/images/thumbnails/img3.png" class="w-full h-full object-cover" alt="thumbnail">
                    <p class="backdrop-blur bg-black/30 rounded-[4px] p-[4px_8px] absolute top-3 right-[14px] z-10">Rp
                        89,000</p>
                </a>
                <div class="p-[10px_14px_12px] h-full flex flex-col justify-between gap-[14px]">
                    <div class="flex flex-col gap-1">
                        <a href="" class="font-semibold line-clamp-2 hover:line-clamp-none">SaaS Website
            ...
            <div class="product-card flex flex-col rounded-[18px] bg-[#181818] overflow-hidden">
                <a href="" class="thumbnail w-full h-[180px] flex shrink-0 overflow-hidden relative">
                    <img src="assets/images/thumbnails/img4.png" class="w-full h-full object-cover" alt="thumbnail">
                    <p class="backdrop-blur bg-black/30 rounded-[4px] p-[4px_8px] absolute top-3 right-[14px] z-10">Rp
                        250,000</p>
                </a>
                <div class="p-[10px_14px_12px] h-full flex flex-col justify-between gap-[14px]">
                    <div class="flex flex-col gap-1">
                        <a href="" class="font-semibold line-clamp-2 hover:line-clamp-none">Vitalize -
                    ...
                    <div class="flex items-center gap-[6px]">
                        <div class="w-6 h-6 flex shrink-0 items-center justify-center rounded-full overflow-hidden">
                            <img src="assets/images/logos/vekotora.svg" class="w-full h-full object-cover"
                                alt="logo">
                        </div>
