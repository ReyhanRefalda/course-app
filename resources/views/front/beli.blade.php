    ...
    <nav class="w-full bg-[#00000010] backdrop-blur-lg z-10">
        <div class="container max-w-[1130px] mx-auto flex items-center justify-between h-[74px]">
            <div class="flex items-center gap-[26px]">
                <a href="{{ route('home') }}" class="flex w-[154px] shrink-0 items-center">
        ...
        <div class="w-full flex justify-center gap-[118px]">
            <div class="product-info flex flex-col gap-4 w-min h-fit mt-[18px]">
                ...
                <div class="product-detail flex flex-col gap-3">
                    <div class="thumbnail w-[412px] h-[255px] flex shrink-0 rounded-[20px] overflow-hidden">
                        <img src="assets/images/thumbnails/checkout.png" class="w-full h-full object-cover" alt="thumbnail">
                    </div>
                    <div class="product-title flex flex-col gap-[30px]">
                        <div class="flex flex-col gap-3">
                            <p class="font-semibold">Huis Elite: The Complete Smart Home App UI Kit for Modern Living</p>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <p class="font-semibold text-4xl bg-clip-text text-transparent bg-gradient-to-r from-[#B05CB0] to-[#FCB16B]">Rp 6,288,000</p>
                        </div>
                    </div>
                </div>
            </div>
            <form class="flex flex-col p-[30px] gap-[60px] rounded-[20px] w-[450px] border-2 border-belibang-darker-grey">
                <div class="w-full flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex gap-3">
                            <div class="flex items-center gap-1 p-[12px_20px] pl-4 w-[163px] justify-between rounded-lg bg-[#181818] hover:ring-[1px] hover:ring-[#A0A0A0] focus:ring-[1px] focus:ring-[#A0A0A0] transition-all duration-300">
                                <div class="flex flex-col">
                                    <label for="bank" class="text-xs text-belibang-grey pl-1">Bank Name</label>
                                    <select name="bank" id="bank" class="mt-1 font-semibold bg-transparent appearance-none outline-none px-1 invalid:text-[#595959] invalid:font-normal invalid:text-sm" required>
                                        <option class="text-belibang-black" value="" selected disabled hidden>Select bank</option>
                                        <option class="text-belibang-black" value="BCA">BCA</option>
                                        <option class="text-belibang-black" value="MANDIRI">MANDIRI</option>
                                    </select>
                                </div>
                                <div class="w-6 h-6 flex shrink-0">
                            ...
                            <div class="flex items-center gap-1 p-[12px_20px] pl-4 w-[215px] justify-between rounded-lg bg-[#181818] hover:ring-[1px] hover:ring-[#A0A0A0] focus:ring-[1px] focus:ring-[#A0A0A0] transition-all duration-300">
                                <div class="flex flex-col w-full">
                                    ...
                                    <div class="flex mt-1 items-center max-w-[149px]">
                                        <input type="text" name="name" id="name" class="font-semibold bg-transparent appearance-none autofull-no-bg outline-none px-1 placeholder:text-[#595959] placeholder:font-normal placeholder:text-sm w-full" placeholder="Type here" required></input>
                                        <button type="button" onclick="copyTextFunc('name')" class="w-[18px] h-[18px] flex shrink-0"><img src="assets/images/icons/copy.svg" alt="icon"></button>
                                    </div>
                                </div>
                                <div class="w-6 h-6 flex shrink-0">
                                    <img src="assets/images/icons/user-square.svg" alt="icon">
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center gap-1 p-[12px_20px] pl-4 justify-between rounded-lg bg-[#181818] hover:ring-[1px] hover:ring-[#A0A0A0] focus:ring-[1px] focus:ring-[#A0A0A0] transition-all duration-300">
                            <div class="flex flex-col w-full">
                                ...
                                <div class="flex mt-1 items-center max-w-[322px]">
                                    <input type="tel" name="number" id="number" class="mt-1 font-semibold bg-transparent appearance-none autofull-no-bg outline-none px-1 placeholder:text-[#595959] placeholder:font-normal placeholder:text-sm w-full" placeholder="Type here" pattern="[0-9 -]" required></input>
                                    <button type="button" onclick="copyTextFunc('number')" class="w-[18px] h-[18px] flex shrink-0"><img src="assets/images/icons/copy.svg" alt="icon"></button>
                                </div>
                            </div>
                            <div class="w-6 h-6 flex shrink-0">
                ...
                <div class="w-full flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-3">
                        <p class="text-xs text-[#2D68F8] p-[10px_22px] rounded-lg bg-[#2D68F805]">Please upload proof of payment we will confirm it as soon as possible</p>
                        <div class="flex gap-3">
                            <button type="button" class="flex gap-2 shrink-0 w-[291px] h-[48px] p-[12px_18px] justify-center items-center border border-dashed border-[#595959] rounded-lg hover:bg-[#2A2A2A] transition-all duration-300" onclick="document.getElementById('proof').click()">
                                <p>Choose File</p>
                                <img src="assets/images/icons/document-upload.svg" alt="icon">
                            </button>
                            ...
                            <div class="relative rounded-lg overflow-hidden bg-[#181818] w-full h-[48px]">
                                <div class="relative file-preview z-10 w-full h-full hidden">
                                    <img src="assets/images/icons/check.svg" class="check-icon absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="icon">
                                    <img src="" class="thumbnail-proof w-full h-full object-cover" alt="thumbnail">
                                </div>
                                <img src="assets/images/icons/gallery.svg" class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="icon">
                            </div>
                        </div>
                    </div>
                </div>
                <a href="success-checkout.html" class="rounded-full text-center bg-[#2D68F8] p-[8px_18px] font-semibold hover:bg-[#083297] active:bg-[#062162] transition-all duration-300">Checkout Now</a>
            </form>
        </div>
    </section>
