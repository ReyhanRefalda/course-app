                ...
                <form action="{{ route('admin.pelajaran.update', $pelajaran->id) }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" name="judul" id="judul"
                            ...
                            value="{{ old('judul', $pelajaran->judul) }}" placeholder="Masukkan judul pelajaran" required>
                        @error('judul')
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="url" name="video_url" id="video_url"
                            ...
                            value="{{ old('video_url', $pelajaran->video_url) }}" placeholder="Masukkan URL video" required>
                        @error('video_url')
                            <span class="text-sm text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
