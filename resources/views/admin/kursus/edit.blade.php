        ...
        <div class="flex flex-col gap-6">
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" name="judul" id="title" value="{{ old('title', $kursus->judul) }}"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" name="deskripsi" id="description"
                        value="{{ old('deskripsi', $kursus->deskripsi) }}"
                        class="p-2 w-full border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
