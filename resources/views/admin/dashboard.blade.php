                            ...
                            <div class="flex gap-6 items-center justify-between">
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <p class="text-gray-500 text-sm font-normal text-nowrap">last year</p>
                                    </div>
                                    <div class="flex">
                        ...
                        <ul class="timeline-widget relative">
                            <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                                ...
                                <div class="timeline-desc py-[6px] px-4">
                                    <p class="text-gray-600 text-sm font-normal">Payment received from John Doe of
                                        $385.90</p>
                                </div>
                            </li>
                            <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                            ...
                            <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                                ...
                                <div class="timeline-desc py-[6px] px-4">
                                    <p class="text-gray-600 text-sm font-normal">Payment was made of $64.95 to Michael
                                    </p>
                                </div>
                            </li>
                                ...
                                <table class="text-left w-full whitespace-nowrap text-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-4">
                                                <span class="font-normal text-sm text-gray-500">Hosting Press
                                                    HTML</span>
                                            </td>
                                            <td class="p-4">
                                                <span
