                            ...
                            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <trix-editor input="content"
                                        class="border-gray-300 rounded-lg bg-gray-50 shadow-sm min-h-80"></trix-editor>
                                ...
                                <div class="md:col-span-1">
                                    ...
                                    <input type="file" name="tumbnail" id="tumbnail" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" onchange="previewImage(event)">
                                    <x-input-error :messages="$errors->get('tumbnail')" />
                                    @if ($artikel->tumbnail)
                                        <img src="{{ asset('storage/' . $artikel->tumbnail) }}" alt="Thumbnail" class="mt-2 h-20 w-20 rounded">
                                    @endif
                                </div>
                            </div>
                        </div>
